...
void HTFT_voidInit(void)
{
    ...
    //MGPIO_voidSetPinMode(HTFT_CS_PORT_PIN, MGPIO_OUTPUT); // PA2 CS
    ...
    /*Hardware Reseting*/
    MGPIO_voidSetPinValue(HTFT_RST_PORT_PIN, MGPIO_OUTPUT_HIGH);
    MSTK_voidSetBusyWait(100);
    MGPIO_voidSetPinValue(HTFT_RST_PORT_PIN, MGPIO_OUTPUT_LOW);
...
{
    u8 Local_u8Dummy;
    MGPIO_voidSetPinValue(HTFT_A0_PORT_PIN, MGPIO_OUTPUT_LOW);
...
{
    u8 Local_u8Dummy;
    MGPIO_voidSetPinValue(HTFT_A0_PORT_PIN, MGPIO_OUTPUT_HIGH);
